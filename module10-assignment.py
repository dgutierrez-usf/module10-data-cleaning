...
df_no_duplicates.loc[:, "purchase_frequency_category"] = df_no_duplicates["total_purchases"].apply(purchase_category)

# Correlation (before filtering)
satisfaction_spend_corr = df_no_duplicates["satisfaction_rating"].corr(df_no_duplicates["total_spent"])

# ✅ ONLY FILTER FOR INSIGHTS (not df_no_duplicates)
df_insights = df_no_duplicates.dropna(subset=["loyalty_status"])

# Final dataset
df_renamed = df_insights.rename(columns={
...
print("- Data Type Issues: dates, currency formatting")

print("\nStandardization Changes:")
print("- Names: Proper case")
print("- Categories: Capitalized consistently")
